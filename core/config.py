...
__C.YOLO.CLASSES              =  "./classes.txt" #"./coco.names"
...
__C.TRAIN.ANNOT_PATH          = "./train_entry_point.txt" #./data/dataset/val2017.txt"
...
__C.TEST.ANNOT_PATH           = "./test_entry_point.txt" # "./data/dataset/val2017.txt"
